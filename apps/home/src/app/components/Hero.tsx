    ...
    <section id="hero" className={styles.hero}>
      <div className={styles.heroContainer}>
          ...
          <div className={styles.terminalWindow}>
            <div className={styles.terminalHeader}>
              <div className={styles.terminalButtons}>
                <span
                  className={`${styles.terminalButton} ${styles.close}`}
                ></span>
                <span
              ...
              <div className={styles.terminalTitle}>sungwook@portfolio:~$</div>
            </div>
            <div className={styles.terminalBody}>
              ...
              <h1 className={`${styles.heroTitle} ${styles.terminalOutput}`}>
              ...
              >
                <span className={styles.terminalPrompt}>$ </span>
                <span className={styles.terminalCommand}>cat about.txt</span>
              </div>
              <p className={`${styles.heroSubtitle} ${styles.terminalOutput}`}>
        ...
        <div className={styles.reactLogoContainer}>
          <svg className={styles.reactLogo} viewBox="0 0 841.9 595.3">
            <g fill="#61DAFB">
